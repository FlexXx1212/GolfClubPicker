...
export const CATEGORY_ICONS: Record<ClubCategory, string> = {
  driver: '/icons/clubs/club_driver.png',
  wood:   '/icons/clubs/club_fairwaywood.png',
  hybrid: '/icons/clubs/club_hybrid.png',
  iron:   '/icons/clubs/club_iron.png',
  wedge:  '/icons/clubs/club_wedge.png',
};
